...
import {
  EntityCommentList,
  type EntityCommentListProps,
} from './entity-comment-list'
import {
  EntityActivityList,
  type EntityActivityListProps,
} from './entity-activity-list'
import {
...
import {
  EntityObjectLinks,
  type EntityObjectLinksProps,
} from './entity-object-links'
...
> = EntityObjectDetailOwnApi<TObject, TDetail> &
  ...
  Pick<
    ...
    'listObjects' | 'createLink' | 'deleteLink'
  >
...
>({
  ...
  const validParentOptions = useMemo(() => {
    ...
    const parentClassIds = (design.hierarchy[object.class] || []).filter(
      (c) => c !== ''
    )
