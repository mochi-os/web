        ...
        <div className='flex min-h-11 items-center gap-2 md:min-h-11 md:justify-between'>
          ...
          {(actions || primaryAction || menuAction) && (
            <div className='flex shrink-0 items-center gap-2'>
              {primaryAction && (
                <div className='hidden md:flex'>{primaryAction}</div>
              )}
              {actions && (
              ...
              {primaryAction && (
                <div className='md:hidden'>{primaryAction}</div>
              )}
