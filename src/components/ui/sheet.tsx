    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'right' &&
          'data-[state=closed]:slide-out-to-end data-[state=open]:slide-in-from-end top-12 md:top-0 bottom-0 end-0 h-[calc(100vh-3rem)] sm:h-screen w-3/4 border-s sm:max-w-sm',
          side === 'left' &&
