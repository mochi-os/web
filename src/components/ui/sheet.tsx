...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn(
        'data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-x-0 top-[var(--sheet-top-offset,3rem)] bottom-0 z-[55] bg-black/50 md:top-0',
        className
      )}
      {...props}
    />
...
function SheetContent({
  ...
  /** False when the content draws its own close button, as SidePanel does. */
